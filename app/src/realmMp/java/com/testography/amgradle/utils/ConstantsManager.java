...
public class ConstantsManager {
    ...
    public static final String FILE_PROVIDER_AUTHORITY = "com.testography.amgradle" +
            ".fileprovider";
    ...
    public static final String REALM_USER = "";
    public static final String REALM_PASSWORD = "";
    public static final String REALM_AUTH_URL = "";
    public static final String REALM_DB_URL = "";
}
